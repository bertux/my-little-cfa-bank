...
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: ZRDuC5TMG9jFe/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__nzfiX)}>
              <p.Stack
                as={"section"}
              ...
              >
                <Reveal
                  big={true}
                  className={classNames("__wab_instance", sty.reveal__eFZf)}
                ...
                <Reveal
                  big={true}
                  cascade={false}
                  className={classNames("__wab_instance", sty.reveal__dnffh)}
                  delay={4000 as const}
              ...
              {true ? (
                <div className={classNames(projectcss.all, sty.freeBox__x6ARo)}>
                  <Reveal
                    className={classNames("__wab_instance", sty.reveal__uVor0)}
                    delay={5000 as const}
