...
import sty from "./PlasmicHeader.module.css"; // plasmic-import: 9R92pPq23TkPW/css
...
function PlasmicHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__mcTid)}>
        {true ? (
          <div className={classNames(projectcss.all, sty.freeBox__voEin)}>
            <p.PlasmicLink
              className={classNames(
                projectcss.all,
                projectcss.a,
        ...
        {true ? (
          <div className={classNames(projectcss.all, sty.freeBox__uzRV)}>
            <p.PlasmicLink
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__atm1C)}
      >
        {true ? (
          <div className={classNames(projectcss.all, sty.freeBox__qJwF)}>
            <p.PlasmicLink
              className={classNames(
                projectcss.all,
                projectcss.a,
        ...
        {true ? (
          <div className={classNames(projectcss.all, sty.freeBox__p3PMx)}>
            <p.PlasmicLink
              className={classNames(
                projectcss.all,
                projectcss.a,
